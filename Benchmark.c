...
char* dsetName;
int verbose;
void _Peripheral(int SW, int SH, int STRIDEZ)
{
    int sW=SW;
    int sH=SH;
    int strideZ=STRIDEZ;
...
void _LeftDiagonEdges(int SW, int SH, int STRIDEZ)
{
...
void _RightDiagonEdges(int SW, int SH, int STRIDEZ)
{
...
void _LeftDiagonSteps(int SW, int SH, int STRIDEX,int STRIDEY,int STRIDEZ)
{
...
void _Hole(int SW, int SH, int STRIDEX, int STRIDEY, int STRIDEZ, int INNERSW, int INNERSH)
{
    int sW=SW;
    int sH=SW;
    int strideX=STRIDEX;
...
int main(int argc, char *argv[])
{
    ...
    while(true)
    {
        ...
        {
            case Peripheral:
                _Peripheral(atoi(argv[5]),atoi(argv[6]),atoi(argv[7]));
                return 0;
            case LeftDiagonEdges:
                _LeftDiagonEdges(atoi(argv[5]),atoi(argv[6]),atoi(argv[7]));
                return 0;
            case RightDiagonEdges:
                _RightDiagonEdges(atoi(argv[5]),atoi(argv[6]),atoi(argv[7]));
                return 0;
            case LeftDiagonSteps:
                _LeftDiagonSteps(atoi(argv[5]),atoi(argv[6]),atoi(argv[7]),atoi(argv[8]),atoi(argv[9]));
                return 0;
            case Hole:
                _Hole(atoi(argv[5]),atoi(argv[6]),atoi(argv[7]),atoi(argv[8]),atoi(argv[9]),atoi(argv[10]),atoi(argv[11]));
                return 0;
            case Quit:
                printf("EXITTING\n");
                return 0;
